	...
	stage('SonarQube analysis') {
	    ...
	    stage('Build Docker Image') {
		    steps {
				...
				sh 'docker tag node us-central1-docker.pkg.dev/tech-rnd-project/network18/node:1'
		    ...
		    steps {
			    script {
				    echo "Push Docker Image"
				        ...
				        sh "sudo docker push us-central1-docker.pkg.dev/tech-rnd-project/network18/node:1"
